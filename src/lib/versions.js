...
exports.getAllVersions =
  ...
  exports.getFullFuelCoreVersion =
  exports.getFuelCoreVersion =
  exports.getRustSDKVersion =
    void 0;
var fs = require('fs');
...
function getRustSDKVersion(docsDir) {
  ...
  return {
    ...
    url: 'https://github.com/FuelLabs/fuels-rs/tree/v'.concat(
      tomfile.workspace.package.version
    ),
  };
}
...
function getForcVersion(docsDir) {
  ...
  var version =
    (_a =
      forcfile === null || forcfile === void 0
        ? void 0
        : forcfile.match(/version = "(.*)"/)) === null || _a === void 0
      ? void 0
      : _a[1];
  return {
    name: 'forc',
...
function getFuelCoreVersion() {
  var filedir = (0, path_1.join)(
    constants_1.DOCS_DIRECTORY,
...
function getFullFuelCoreVersion(versionSet) {
  ...
  return {
    ...
    category: 'GraphQL API',
    version: tomfile.workspace.package.version,
    url: 'https://github.com/FuelLabs/fuel-core/tree/v'.concat(
      tomfile.workspace.package.version
    ),
  };
}
