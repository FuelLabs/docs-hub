...
export class Doc {
  ...
  constructor(slug: string[], mdDocs: MdDoc[]) {
    ...
    const actualPath = `/tree/${branch}/${splitPath
      ...
      .replace("docs/migrations-and-disclosures/", "")
    ...
    if (pageLink.includes("migrations-and-disclosures/breaking-changes-log")) {
      pageLink =
        "https://github.com/FuelLabs/migrations-and-disclosures/blob/master/breaking-changes-log.md";
    }
