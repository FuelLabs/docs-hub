...
exports.DEFAULT_THEME = exports.NAVIGATION = exports.EXTERNAL_NAVIGATION_LINKS = exports.BRIDGE_LINK = exports.BETA_4_EXPLORER_LINK = exports.EXPLORER_LINK = exports.BETA_4_PLAYGROUND_LINK = exports.PLAYGROUND_LINK = exports.BETA_4_FAUCET_LINK = exports.FAUCET_LINK = exports.FUEL_TESTNET_UPPER_CASE = exports.FUEL_TESTNET = exports.FIELDS = exports.BETA_4_DOCS_DIRECTORY = exports.NIGHTLY_DOCS_DIRECTORY = exports.DOCS_DIRECTORY = void 0;
var path_1 = require("path");
exports.DOCS_DIRECTORY = (0, path_1.join)(process.cwd(), './docs');
exports.NIGHTLY_DOCS_DIRECTORY = (0, path_1.join)(process.cwd(), './docs/nightly');
exports.BETA_4_DOCS_DIRECTORY = (0, path_1.join)(process.cwd(), './docs/beta-4');
exports.FIELDS = ['title', 'slug', 'content', 'category'];
exports.FUEL_TESTNET = 'beta-5';
exports.FUEL_TESTNET_UPPER_CASE = 'Beta-5';
exports.FAUCET_LINK = "https://faucet-".concat(exports.FUEL_TESTNET, ".fuel.network/");
exports.BETA_4_FAUCET_LINK = 'https://faucet-beta-4.fuel.network/';
exports.PLAYGROUND_LINK = "https://".concat(exports.FUEL_TESTNET, ".fuel.network/playground/");
exports.BETA_4_PLAYGROUND_LINK = 'https://beta-4.fuel.network/playground/';
exports.EXPLORER_LINK = 'https://next-app.fuel.network/';
exports.BETA_4_EXPLORER_LINK = 'https://fuellabs.github.io/block-explorer-v2/beta-4/';
