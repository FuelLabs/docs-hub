...
// const workspaceRoot = path.resolve(__dirname, '../..'); // Remove this calculation

// Define paths relative to the presumed execution directory (workspace root)
const sourceDir = path.resolve('docs', 'migrations-and-disclosures', 'docs', 'src');
const targetDir = path.resolve('mono-mdbook-final', 'migrations-and-disclosures-book', 'src');
