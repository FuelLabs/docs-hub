...
```sway
<!-- MDBOOK-ANCHOR-ERROR: Anchor 'temp_hash_import' not found in '../../../../examples/advanced_storage_variables/src/main.sw' -->
```
...
```sway
<!-- MDBOOK-ANCHOR-ERROR: Anchor 'storage_vec_import' not found in '../../../../examples/advanced_storage_variables/src/main.sw' -->
```
...
```sway
<!-- MDBOOK-ANCHOR-ERROR: Anchor 'storage_bytes_import' not found in '../../../../examples/advanced_storage_variables/src/main.sw' -->
```
...
```sway
<!-- MDBOOK-ANCHOR-ERROR: Anchor 'storage_string_import' not found in '../../../../examples/advanced_storage_variables/src/main.sw' -->
```
