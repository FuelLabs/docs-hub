...
export type FuelsConfig = UserFuelsConfig & Required<Pick<UserFuelsConfig, 'contracts' | 'predicates' | 'scripts' | 'deployConfig' | 'useBuiltinForc' | 'useBuiltinFuelCore' | 'autoStartFuelCore' | 'providerUrl'>> & {
    basePath: string;
    configPath: string;
};
