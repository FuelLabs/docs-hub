...
cardsInfo={[
{
          ...
          beta5Link: '/docs/beta-5/fuels-rs',
          isExternal: false,
          heading: 'Rust SDK',
        ...
        },
        {
          ...
          beta5Link: '/docs/beta-5/fuels-ts',
          isExternal: false,
        ...
        },
        {
          ...
          beta5Link: '/docs/beta-5/wallet/install',
          isExternal: false,
          heading: 'Wallet SDK',
          headingIcon: 'Wallet',
        ...
        },
        {
         link: '/docs/graphql',
          ...
          beta5Link: '/docs/beta-5/graphql/overview',
          isExternal: false,
          heading: 'GraphQL API',
