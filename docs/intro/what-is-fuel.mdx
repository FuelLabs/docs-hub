...
cardsInfo={[
{
          ...
          beta4Link: '/docs/beta-4/fuels-rs',
          isExternal: false,
          heading: 'Rust SDK',
        ...
        },
        {
          ...
          beta4Link: '/docs/beta-4/fuels-ts',
          isExternal: false,
        ...
        },
        {
          ...
          beta4Link: '/docs/beta-4/wallet/install',
          isExternal: false,
          heading: 'Wallet SDK',
          headingIcon: 'Wallet',
        ...
        },
        {
         link: '/docs/graphql',
          ...
          beta4Link: '/docs/beta-4/graphql/overview',
          isExternal: false,
          heading: 'GraphQL API',
