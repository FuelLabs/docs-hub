...
- Use code examples whenever possible. Always specify the language of a code block.
...
If you are editing or writing a guide or the `intro` section, follow these additional guidelines:
