...
2. [Connect to the Beta 4 Fuel Network:](/guides/running-a-node/running-a-beta-4-node) With this setup, your local node will connect and sync with the Beta 4 version of the Fuel network.
3. [Connect to the Beta 5 Fuel Network:](/guides/running-a-node/running-a-beta-5-node) With this setup, your local node will connect and sync with the Beta 5 version of the Fuel network.
