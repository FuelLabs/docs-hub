...
1. [Run a Local Fuel Network Node:](/guides/running-a-local-node) This setup allows you to run a node that operates solely on your local environment.
2. [Connect to the Beta 4 Fuel Network:](/guides/running-a-beta-4-node) With this setup, your local node will connect and sync with the beta4 version of the Fuel network.
