...
3. [Connect to the Mainnet Fuel Network:](/guides/running-a-node/running-a-mainnet-node) With this setup, your local node will connect and sync with the Mainnet version of the Fuel network.
