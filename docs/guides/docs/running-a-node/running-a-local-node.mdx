...
<CodeImport
  file="../../../fuel-core/bin/fuel-core/chainspec/local-testnet/chain_config.json"
/>

`metadata.json`

<CodeImport
  file="../../../fuel-core/bin/fuel-core/chainspec/local-testnet/metadata.json"
/>

`state_config.json`

<CodeImport
  file="../../../fuel-core/bin/fuel-core/chainspec/local-testnet/state_config.json"
/>

`state_transition_bytecode.wasm`

Which is too large to display on this page, but you can find it [here](https://github.com/FuelLabs/fuel-core/blob/master/bin/fuel-core/chainspec/local-testnet/state_transition_bytecode.wasm)
...
To find an example chain configuration folder for a specific `fuel-core` version, refer to the [`fuel-core`](https://github.com/FuelLabs/fuel-core/tree/master/bin/fuel-core/chainspec/local-testnet) repo.
