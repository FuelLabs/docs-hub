...
Here is an example of what that looks like using version {props.versionSet === '0.22.4' ? 'beta-5' : props.fuelCoreVersion} of `fuel-core`:
...
<CodeImport
  file="../../../beta-5/fuel-core/deployment/scripts/chainspec/dev_chainspec.json"
  lang="json"
/>
</ConditionalContent>
