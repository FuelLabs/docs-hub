...
<ConditionalContent versionSet={props.versionSet} showForVersions={['beta-5']}>
To run a `beta-5` node, you will need to install the `beta-5` toolchain.
...
<ConditionalContent versionSet={props.versionSet} showForVersions={['default', 'nightly']}>
Here is the [specific configuration](https://github.com/FuelLabs/fuel-core/blob/v0.22.0/deployment/scripts/chainspec/beta_chainspec.json) for the testnet:
...
<ConditionalContent versionSet={props.versionSet} showForVersions={['beta-5']}>
Here is the [specific configuration](https://github.com/FuelLabs/fuel-core/blob/v0.20.4/deployment/scripts/chainspec/beta_chainspec.json) for `beta-5`:

<CodeImport
  file="../../../beta-5/fuel-core/deployment/scripts/chainspec/beta_chainspec.json"
  lang="json"
/>
</ConditionalContent>
