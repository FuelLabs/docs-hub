...
While the official wallet extension update is under review for the chrome webstore, we will use the Fuel Development Wallet to interact with the latest testnet.
...
Once you've installed the wallet, click the "Faucet" button to get some testnet tokens.
...
<CodeTabs>
```sh
pnpm add fuels@0.72.0 @fuel-wallet/sdk@0.15.1 @fuel-wallet/react@0.15.1
```
```sh
npm install fuels@0.72.0 @fuel-wallet/sdk@0.15.1 @fuel-wallet/react@0.15.1
```
</CodeTabs>
