...
<ConditionalContent versionSet={props.versionSet} showForVersions={['beta-4']}>
```sh
npm install fuels@0.60.0 @fuel-wallet/sdk@0.13.10
```
</ConditionalContent>
...
<ConditionalContent versionSet={props.versionSet} showForVersions={['beta-4']}>
[Here is the repo for this project](https://github.com/FuelLabs/docs-hub/tree/master/docs/beta-4/guides/examples/quickstart).
</ConditionalContent>
