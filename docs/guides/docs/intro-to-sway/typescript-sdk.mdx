...
```sh
npm install fuels@0.66.1 @fuel-wallet/sdk@0.13.5 @fuel-wallet/react@0.13.7 --save
```
...
action={{
  name: 'runCommand',
  commandFolder: 'guides-testing/fuel-project/frontend/src/App.tsx'
}}
/>
...
Next, we will be using the webhooks from the Fuel Wallet package in order to connect our wallet to the dapp
