...
<ConditionalContent versionSet={props.versionSet} showForVersions={['beta-5']}>
<CodeImport
  file="../../../beta-5/guides/examples/counter-dapp/frontend/src/App.tsx"
  lang="tsx"
/>
</ConditionalContent>
...
<ConditionalContent versionSet={props.versionSet} showForVersions={['beta-5']}>
[Here is the repo for this project](https://github.com/FuelLabs/docs-hub/tree/master/docs/beta-5/guides/examples/counter-dapp).
</ConditionalContent>
