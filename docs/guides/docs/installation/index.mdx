...
> 💡 Check up the [Fuelup docs](docs/fuelup) for more information.
...
Basically you are allowing your terminal to use the `fuelup` command.
...
> 💡 Check up the [Networks section](docs/about-fuel) for more information.
...
### Use Nix to install Fuel toolchain

Nix is a cross-platform package manager for advanced users.

> 👉 Check out the [Nix flake for Fuel](/docs/nix) to learn more.
