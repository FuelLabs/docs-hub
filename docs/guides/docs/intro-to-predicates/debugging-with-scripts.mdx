...
<TestAction
id="create-project-folder-debug"
action={{
  name: 'runCommand',
...
```sh
mkdir predicate-script-logging
```
...
<CodeImport
  file="../../examples/intro-to-predicates/script-test-example/src/main.sw"
...
action={{
  name: 'writeToFile',
  filepath: 'guides-testing/predicate-script-logging/predicate/src/main.sw'
}}
/>
...
action={{
  name: 'runCommand',
  commandFolder: 'guides-testing/predicate-script-logging/predicate'
}}
/>
