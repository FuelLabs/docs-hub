...
<span id="contract-1"></span>

<CodeImport
  file="../../guide-examples/quickstart/counter-contract/src/main.sw"
  comment="contract"
  commentType="//"
  lang="sway"
/>
...
<span id="install-cargo-generate"></span>
...
<CodeImport
  file="../../guide-examples/quickstart/counter-contract/tests/harness.rs"
